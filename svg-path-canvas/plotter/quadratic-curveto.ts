...
import { SVGCommand, QuadraticCurveToCommand } from './parser';
...
/**
  ...
  */
export function createQuadraticCurveToCommand(cmd: QuadraticCurveToCommand, originalCmd: SVGCommand): SVGFunction {
