...
import { CurveToCommand } from 'svg-path-parser';
...
/**
  ...
  */
export function createCurveToCommand(cmd: CurveToCommand): SVGFunction {
  ...
  return function p0CurveToCommand(p0: [number, number]) {
